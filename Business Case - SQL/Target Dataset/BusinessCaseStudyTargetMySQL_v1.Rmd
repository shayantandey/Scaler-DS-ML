...
We will consider the *delivered* order_status, for calculating *time_to_deliver*,  
because *order_delivered_customer_date* does not exist for the other *order_status*.
