...
345 orders had actual delivery more than 30 days later than the estimated delivery.  
Estimation of delivery date should be revised.

```{sql, connection=target_db}
SELECT COUNT(*) as delivery_estimate_miss_30_days
FROM orders
WHERE DATEDIFF(order_delivered_customer_date, order_estimated_delivery_date) > 30;
```
